...
sys.path.append('/app/autogen')

# Try importing the autogenerated package
try:
    # This import will adapt to your module name based on your actual Rust module
    import autogen
    print("Successfully imported autogen package")
except ImportError as e:
    print(f"Error importing autogen package: {e}")
    print("Available modules in sys.path:", sys.path)
...
async def connect_to_spacetimedb():
    ...
    try:
        # Create a SpacetimeDB client instance with the autogen package
        print(f"Connecting to SpacetimeDB at {SPACETIME_HOST}:{SPACETIME_PORT}")
        client = SpacetimeDBClient(
            host=SPACETIME_HOST,
            port=int(SPACETIME_PORT),
            autogen_package=autogen  # Use the imported autogen package
        )
        ...
        existing_entities = client.query("get_all_entities", [])
